...
from accounts.models import User,TrackingModel
...
class Property(TrackingModel):
    ...
    building_age_choice=(
        ...
        ("4-7 Yrs","4-7 Yrs"),
        ("8-12 Yrs","8-12 Yrs"),
        ("above 13 Yrs", "above 13 Yrs")
    )
    property_title=models.CharField(_("Property title"),max_length=90)
    status=models.CharField(_("Property status"),max_length=20,choices=property_status_choice)
    property_type=models.ForeignKey(Property_Type,related_name="types",on_delete=models.CASCADE)
    ...
    Bed_rooms=models.PositiveIntegerField(_("bed rooms"),default=1)
    garage=models.PositiveIntegerField(_("garage"),blank=True,null=True)
    area=models.CharField(_("Area/Size"),max_length=18,help_text="SqFt")
    property_gallery=models.ImageField(_("property gallery"),upload_to="property/")
    ...
    description=models.TextField(_("Detailed Information"),blank=True,null=True)
    building_age=models.CharField(_("Building age"),choices=building_age_choice,max_length=56)
    floor_plan=models.ImageField(_("floor plan"),upload_to="building plan",blank=True,null=True)
